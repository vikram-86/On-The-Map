...
//  Spinner
//
//  Created by Suthananth Arulanantham on 21.06.15.
...
/***********************************************************************************
    This class is inspired by The Activity indicator class and the view alert class.
    An indicator is animated with an info text
